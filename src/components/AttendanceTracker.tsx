...
export function AttendanceTracker({
      ...
      try {
        ...
        const { data: attendanceData, error: attendanceError } =
          await (supabase as any)
            ...
            .select(
              "student_id, status, understanding_level, feedback",
            )
  ...
  const updateStudent = (
    studentId: string,
    patch: Partial<StudentAttendance>,
  ) => {
  ...
  const saveAttendance = async () => {
    ...
    try {
      ...
      toast.success(
        isArabic
          ? "تم حفظ الحضور والمتابعة"
          : "Attendance and feedback saved",
      );
    } catch (error) {
