...
function WorksheetPage() {
  ...
  if (items.length === 0) {
    return (
      <main dir="rtl" className="grid min-h-screen place-items-center p-8 text-center">
        <p className="text-muted-foreground">لا توجد ورقة عمل — ولّدها من صفحة التخطيط.</p>
      </main>
    );
  }
  ...
  return (
    <main dir="rtl" className="mx-auto max-w-3xl bg-white p-8 text-black print:p-0">
      ...
      <section className="mt-10 break-before-page">
        <h2 className="mb-3 border-b-2 pb-2 text-xl font-black" style={{ borderColor: "#B8860B", color: "#1B2A4A" }}>
